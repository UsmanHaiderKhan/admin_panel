...
if(isset($_POST['submit'])){
 ...
 if(in_array($file_check,$file_ext_stored)){
  $destination_file ='assets/img/team/'.$filename;
  move_uploaded_file($file_tmp,$destination_file);
 
 $q = " INSERT INTO `team`(`team_image`, `name`, `job_title`, `twitter`, `facebook`, `linkedin`) VALUES ('$destination_file','$name','$tittle','$twitter','$facebook','$linkedin')";
            ...
            <div class="col-md-9">
                <div class="card p-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                        <label>Name</label>
                            <textarea name="name" id="your_summernote" class="form-control" rows="4"></textarea><br>
                        <label> Job Tittle </label>
                            <input type="text" name="tittle" class="form-control"> <br>
                        <label> Twitter </label>
