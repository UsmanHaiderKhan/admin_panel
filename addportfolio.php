...
if(isset($_POST['submit'])){
 ...
 $destination_file ='assets/img/port/'.$filename;
 move_uploaded_file($file_tmp,$destination_file);
 
 $q = " INSERT INTO `portfolio`(`heading`, `big_description`, `port_image`, `link`) VALUES ('$heading','$description','$destination_file','$link')";
        ...
        <div class="row justify-content-center" style="margin-top:7rem;">
            <div class="col-md-9">
                <div class="card p-4">
                    ...
                    <label> Heading: </label>
                    <textarea name="heading" id="your_summernote" class="form-control" > </textarea><br>
                    <label> Links: </label>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="your1_summernote" class="form-control" rows="4"></textarea>
                        </div>
                    </div><br>
