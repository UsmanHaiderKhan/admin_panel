...
if(in_array($file_check,$file_ext_stored)){
 ...
 $q = "UPDATE `services_tbl` SET `id`='$id',`heading`='$heading',`description`='$description',`about_img`='$destination_file' WHERE id = {$id} ";
        ...
        <?php
            ...
            <div class="col-md-9">
                <div class="card p-4">
                    ...
                    <input type="file" name="file" id="file" class="form-control"><img src="<?php echo $res['service_img'];  ?>" alt=""> <br>
